...
type Config struct {
	...
	SeqEncoding          string                 `protobuf:"bytes,28,opt,name=seqEncoding,proto3" json:"seqEncoding,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Config) GetSeqEncoding() string {
	if x != nil {
		return x.SeqEncoding
	}
	return ""
}
...
const file_transport_internet_splithttp_config_proto_rawDesc = "" +
	...
	"\x10hKeepAlivePeriod\x18\x06 \x01(\x03R\x10hKeepAlivePeriod\"\xe4\v\n" +
	"\x06Config\x12\x12\n" +
	...
	"\vseqEncoding\x18\x1c \x01(\tR\vseqEncoding\x1a:\n" +
